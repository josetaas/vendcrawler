...
.. image:: https://travis-ci.org/mapbox/vendcrawler.svg
   :target: https://travis-ci.org/mapbox/vendcrawler

.. image:: https://coveralls.io/repos/mapbox/vendcrawler/badge.png
   :target: https://coveralls.io/r/mapbox/vendcrawler
...
To use vendcrawler as the start of a new project, do the following, preferably in
a virtual environment. Clone the repo.

.. code-block:: console

    git clone https://github.com/mapbox/vendcrawler myproject
    cd myproject

Replace all occurrences of 'vendcrawler' with the name of your own project.
(Note: the commands below require bash, find, and sed and are yet tested only on OS X.)

.. code-block:: console

    if [ -d vendcrawler ]; then find . -not -path './.git*' -type f -exec sed -i '' -e 's/vendcrawler/myproject/g' {} + ; fi
    mv vendcrawler myproject
...
To help prevent uncustomized forks of vendcrawler from being uploaded to PyPI,
...
when you customize vendcrawler.
...
https://www.mapbox.com/blog/vendcrawler/.
